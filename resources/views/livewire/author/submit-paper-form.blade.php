              ...
              <div class="space-y-3">
                <label class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-700">
                    I confirm that this paper follows the <a href="{{route('paper.print' , 'IEEE-paper-format-template.docx')}}" class="text-blue-600 hover:underline" download>AISTEEL conference template</a> and submission guidelines
                  </span>
                </label>
